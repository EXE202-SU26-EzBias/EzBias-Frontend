...
const Footer = () => (
  <footer className="bg-[rgba(244,243,247,0.4)] px-6">
    <div className="mx-auto max-w-[1400px] px-4">
      <div className="flex flex-wrap items-center justify-between gap-4 border-t border-[#e6e6e6] py-8">
      ...
      <div className="flex items-center border-t border-[#e6e6e6] py-3">
        <Link
          to="/privacy-policy"
          className="text-xs text-[#737373] transition-colors hover:text-[#121212]"
        >
          Privacy Policy
        </Link>
      </div>
